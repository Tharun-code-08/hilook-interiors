...
import { Button, Card, PageHeader, TextArea, TextField } from "../../components/ui";
...
export default function ContentAdmin({ initial }: { initial: Settings }) {
  // Non-null from the start: the settings arrive server-rendered, so the null
  // state and its loading branch no longer exist.
