...
export default function ServicesAdmin({ initial }: { initial: Service[] }) {
  ...
  // Refetch after a create, where the server assigns the id and position.
  // There is deliberately no fetch on mount: the list arrives server-rendered,
  // and fetching it again would reintroduce the round trip this removed.
  async function load() {
